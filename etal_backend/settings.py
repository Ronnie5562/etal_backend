...
ROOT_URLCONF = "etal_backend.urls"
...
WSGI_APPLICATION = "etal_backend.wsgi.application"
...
EMAIL_HOST_USER = config("EMAIL_HOST_USER", default="no-reply@etal.com")
...
cloudinary.config(
    cloud_name=config("CLOUDINARY_CLOUD_NAME", default="etal_platform"),
...
CSRF_COOKIE_HTTPONLY = False  # Allow frontend to read the CSRF token via JavaScript
